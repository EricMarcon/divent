...
Data may be abundance vectors or matrices (the number of indivual per species, possibly per site), lists of individuals, or point patterns to address spatially-explicit diversity.
Random communities can be simulated (`rcommunity`) and spatialized (`rspcommunity`).
