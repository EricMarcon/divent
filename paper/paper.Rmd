...
Spatially-explicit diversity is completely new in *divent*.
...
-   diversity is derived from entropy, following the information theory.
-   richness estimation is not limited to Chao's estimators. The jackknife estimator is often employed to reduce diversity underestimation owing to undersampling.
-   phylogenies must be ultrametric and no functional distance cutoff is proposed for theoretical arguments.
