...
It is a reboot of the *entropart* package, following the tidyverse manifest and easier to use.
...
Bias correction is rarely available except in the *EntropyEstimation* [@Cao2014] package which provides the Zhang and Grabchak's estimators of entropy and diversity and their asymptotic variance (not included in *divent*).
