...
RcppExport SEXP _divent_parallelCountNbd(SEXP rSEXP, SEXP NbSpeciesSEXP, SEXP xSEXP, SEXP ySEXP, SEXP TypeSEXP, SEXP WeightSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_divent_parallelCountNbd", (DL_FUNC) &_divent_parallelCountNbd, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_divent(DllInfo *dll) {
